...
/**
 * Created by AimanDev on 23.01.2016.
 */
...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
	...
	public void initialise() {
		this.channels = NetworkRegistry.INSTANCE.newChannel(DayZMain.MODID, this);
		network = NetworkRegistry.INSTANCE.newSimpleChannel("stalker");
		//network.registerMessage(PacketSyncPlayer.Handler.class, PacketSyncPlayer.class, 0, Side.SERVER);
		registerPackets();
	}
	 ...
	 * @param point
	 *            The
	 *            {@link NetworkRegistry.TargetPoint}
